...
def main():
    ...
    parser.add_argument("--min-amount", type=int, default=50000, help="Số tiền tối thiểu (default: 50000)")
    parser.add_argument("--max-amount", type=int, default=500000, help="Số tiền tối đa (default: 500000)")
